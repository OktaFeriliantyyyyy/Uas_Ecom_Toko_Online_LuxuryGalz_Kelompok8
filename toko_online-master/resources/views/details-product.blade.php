...
<main>
    <section class="clean-block clean-product" >
        <div class="container">
            <nav aria-label="breadcrumb" style="margin-top: 100px; background-color: #b9cdeb">
                <ol class="breadcrumb">
            ...
            <div class="block-content"  style="border-radius: 20px 20px 20px 20px; background-color: #bf73c0">
                <div class="product-info">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="gallery" style="border-radius: 300px 300px 0px 0px">
                        ...
                        <div class="col-md-6">
                            <div class="info text-white">
                                ...
                                <hr>
                                <p>Silahkan Tambahkan ke Keranjang Anda</p>
                                ...
                                <div class="summary p-0 text-white">
                                    <div class="price">
                ...
                <div class="product-info">
                    <div>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane active fade show description text-white" role="tabpanel" id="description">
                                {!! $product->description !!}
                            </div>
                            <div class="tab-pane fade show specifications text-white" role="tabpanel" id="specifications">
