...
@endsection
@section('content')
<main class="catalog-page" style="margin-top: 84px background-color: #b9cdeb">
    <section class="clean-block clean-catalog dark pt-5" style="background-color: #b9cdeb">
        <div class="container" style="margin-top: 64px">
            <div class="content" style="border-radius: 20px 20px 20px 20px; background-color: #bf73c0">
                <div class="row">
                    <div class="col-md-3">
                        <div class="p-4 mt-2">
                            <div class="filter-item mb-3">
                                <form action="{{ route('search') }}" method="get">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Cari..." name="keyword" autocomplete="off" value="{{ old('keyword') }}">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="clean-product-item">
                                        ...
                                        <div class="product-name text-white">
                                            <a href="{{ route('details-product', ['id' => $product->id, 'name' => strtolower(str_replace(' ','-',$product->name))] )}}">
                                                <p class="block-with-text text-white" data-toogle="tooltip" title="{{ $product->name }}" >{{ $product->name }}</p>
                                            </a>
                                        </div>
                                        <div class="about">
                                            <div class="price">
