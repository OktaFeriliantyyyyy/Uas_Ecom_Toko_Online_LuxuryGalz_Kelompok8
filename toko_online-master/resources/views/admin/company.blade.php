...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Profil Luxury Galz</h1>
    </div>
    ...
    <form action=" {{ route('update-company', ['id' => $company->id]) }} " method="post">
        ...
        <div class="row mb-3">
            <div class="col-lg-6 mb-3">
                <div class="card shadow h-100">
                    <div class="card-header">
                        <h5 class="m-0 pt-1 font-weight-bold text-black-50">Atur Profil</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <label for="nama_perusahaan">Nama Website E-Commerce</label>
            ...
            <div class="col-lg-6 mb-3">
                <div class="card shadow h-100">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="bukalapak">Instagram</label>
        ...
        <div class="row mb-3">
            <div class="col-lg">
                <div class="card shadow h-100">
                    <div class="card-header">
                        <h5 class="m-0 pt-1 font-weight-bold text-black-50">Ubah Pengaturan</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
