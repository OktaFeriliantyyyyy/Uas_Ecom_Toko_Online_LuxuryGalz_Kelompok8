...
@section('title','Dashbord Admin - Luxury Galz')
...
<div class="row" >
    ...
    <div id="buttonShowPesananMasuk" class="col-xl-4 col-md-6 mb-4" >
        <div class="card border-left-primary shadow h-100 py-2" style=" background-color: #80227d">
            <div class="card-body" style=" background-color: #80227d">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Pesanan Masuk</div>
                        <div class="h5 mb-0 font-weight-bold text-white">{{ $orderEntry }}</div>
                    </div>
                    <div class="col-auto">
    ...
    <div id="buttonShowPesananDalamProses" class="col-xl-4 col-md-6 mb-4" >
        <div class="card border-left-success shadow h-100 py-2" style=" background-color: #80227d">
            <div class="card-body" style=" background-color: #80227d">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Pesanan Dalam Proses</div>
                        <div class="h5 mb-0 font-weight-bold text-white">{{ $orderProcessed }}</div>
                    </div>
                    <div class="col-auto">
    ...
    <div id="buttonShowPesananSelesai" class="col-xl-4 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2"style=" background-color: #80227d">
            <div class="card-body"style=" background-color: #80227d">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col-auto">
                                <div class="h5 mb-0 mr-3 font-weight-bold text-white">{{ $orderFinished }}</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-auto">
