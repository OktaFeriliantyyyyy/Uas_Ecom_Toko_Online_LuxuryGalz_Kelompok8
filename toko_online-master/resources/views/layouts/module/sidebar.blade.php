        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background: url({{ asset('img/navbar/footr.png') }})">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
                ...
                <div class="sidebar-brand-text mx-3">Luxury Galz</div>
            </a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ route('my-profile') }}">Profil Admin</a>
                        ...
                        <a class="collapse-item" href="{{ route('my-profile') }}">Profil Admin</a>
            ...
            <li class="nav-item active">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-fw fa-wrench"></i><span>Pengaturan</span>
                </a>
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Pilih Pengaturan:</h6>
                        @if ($subtitle == "Perusahaan")
                        <a class="collapse-item active" href="{{ route('company') }}">Luxury Galz</a>
                        ...
                        <a class="collapse-item" href="{{ route('company') }}">Luxury Galz</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Kostum Pengaturan:</h6>
                        <a class="collapse-item" href="{{ route('company') }}">Luxury Galz</a>
                        <a class="collapse-item" href="{{ route('home-picture') }}">Slideshow</a>
                        <a class="collapse-item" href="{{ route('testimonials.index') }}">Testimonial</a>
                    </div>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseProduct" class="collapse show" aria-labelledby="headingProduct" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Kostum Kelola Penjualan:</h6>
                        @if ($subtitle == 'Produk')
